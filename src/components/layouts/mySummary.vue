...
<template>
  <el-row id="summary" class="my-el-row">
    <el-text class="justified-text">
      ...
      applied machine learning and AI algorithms to solve complex distribution
      database performance optimization problems in SaaS multi-tenant Model,
      resulting in a 9.8% increase in efficiency by thesis analysis.
    </el-text>
  </el-row>
</template>
